    ...
    const teamMembers = [
        {
            ...
            name: "Priya Sharma",
            role: "President",
            feedback: "Leading C-Square into its next chapter of competitive coding and innovation.",
            initials: "PS",
            rating: 5
        },
        {
            ...
            name: "Rahul Verma",
            role: "Technical Lead",
            feedback: "Responsible for organizing all the technical workshops, bootcamps, and curriculum.",
            initials: "RV",
            rating: 5
        },
        {
            ...
            feedback: "Ensuring our hackathons and competitions run smoothly for hundreds of participants.",
            initials: "AS",
            rating: 5
        }
    ]
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px]">
                    {teamMembers.map((item) => (
                        <div key={item.id} className="bg-glassBg border border-glassBorder backdrop-blur-[18px] p-[30px] lg:p-[40px_32px] rounded-[24px] transition-all duration-400 ease flex flex-col justify-between h-full hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(0,0,0,0.2)] hover:border-[rgba(255,215,0,0.3)] hover:shadow-primaryGlow">
                            ...
                            <p className="text-[1.05rem] leading-[1.7] text-textMain mb-[30px] italic flex-grow">"{item.feedback}"</p>
